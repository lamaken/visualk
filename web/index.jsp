...
<html>
    <head>
        ...
        <meta name="Keywords" content="experiments, horizon maker, hrzmkr, mosaics, mosaic editor" />
        <meta name="Description" content="Let computer draw or paint for you." />
        <meta name="Author" content="lamaken@gmail.com" />

        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:site" content="@hrzmkr">
        <meta name="twitter:title" content="alk@soft  ~visualk v0.1">
        <meta name="twitter:description" content="visualk experiments.">
        <meta name="twitter:image" content="http://alkasoft.org/visualk/hrz/Hrz?option=firma">

        <meta property="og:image" content="http://alkasoft.org/visualk/hrz/Hrz?option=firma" itemprop="thumbnailUrl">
        <meta property="og:title" content="alk@soft  ~visualk v0.1">
        <meta property="og:url" content="http://alkasft.org/visualk/">
        <meta property="og:site_name" content="CodePen">
        <meta property="og:description" content="visualk experiments.">
