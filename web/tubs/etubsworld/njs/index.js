...
function tubsworld() {
	...
	data.innerHTML = "<b>" + "pathName:" + circuitXML.name + "<br/>" + "id:" + circuitXML.id + "<br/>" + "version:" + circuitXML.version + "<br/>" + "author:" + circuitXML.author + "<br/>" + "md5:" + circuitXML.md5 + "</b>";
...
function clearCanvas() {
	...
	if (r == true) {
		...
		var data = document.getElementById("data");
		data.innerHTML = "<b>" + "pathName:<br/>" + "id:" + "<br/>" + "version:" + "<br/>" + "author:" + "<br/>" + "md5:	" + "</b>";
