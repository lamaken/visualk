...
public class Viewer extends Xhtml5 {
            ...
            try {
                while (myResult.next()) {
                    ...
                    if (tipus.equals("Label")) {
                        fluxeSurvey.addLabel(caption, newname, id_tp);
                    }
                    if (tipus.equals("EditBox")) {
                        fluxeSurvey.addTextBox(caption, newname, id_tp);
                    }
    ...
    public Viewer(String eml_or_code, String session) {
        ...
        super("ss/SurveyServer", session, "Viewer");

        viewDB = new ViewDB("ss_user","ss_password","surveyserver_db");
        ...
        if (eml_or_code == null) {
            this.setEmail_or_code(session);
        } else {
            this.setEmail_or_code(eml_or_code);
        }
