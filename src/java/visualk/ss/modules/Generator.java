...
//		conditionsBar.clear();
		...
		if(enquesta!=null){
			...
			try {
				while(myResult.next()){
					 ...
					 if(tipus.equals("Label"))this.addLabel(caption, newname);
					 if(tipus.equals("EditBox"))this.addTextBox(caption, newname);
	...
	//	this.addBodyData(mapBar.toHtml());
		...
		if(enquesta!=null)this.addBodyData(enquesta.getHtml());
