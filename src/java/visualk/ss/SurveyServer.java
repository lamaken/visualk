...
public class SurveyServer extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if ((login_name == null) || (login_name.equals(""))) {
            login_name = "anonimous";
        }
        if ((login_pass == null) || (login_pass.equals(""))) {
            login_pass = "anonimous";
        }
        ...
        if ((!where.equals("generator")) && (acepted_code == false)) {
            ...
            if (login_name.equals("anonimous")) {
                acepted_code = true;
            }
        ...
        if ((acepted_login) && (where.equals("analysis"))) { //
            ...
            if ((acepted_code) && (where.equals("view"))) { //
                if (actions.equals("start")) {
                    ...
                    for (int n = 1; n <= c; n++) {
                        resp.add(request.getParameter("object_" + n));
                    }
        ...
        if (error) {
            System.out.println("!error!, where:" + where + " actions:" + actions + " params:" + params);
        } else {
            System.out.println("debug: where:" + where + " actions:" + actions + " params:" + params + "more:" + more);
        }

        if (error) {
            html = "!Acció no desenvolupada!, where:" + where + " actions:" + actions + " params:" + params;
        }
