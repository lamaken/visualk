...
public class Hrz extends HttpServlet {
	...
	public static final String SERVELT_URL="Hrz";
    ...
    public Hrz() {
        ...
        listH = new ListHorizons(Main.getString("title.gallery.hrzmkr"));
    	artzar = new Artzar(Main.getString("title.artzar.hrzmkr"));
